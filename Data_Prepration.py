...
## Is the property in a Locality on the coast?
    def is_locality_on_Coast(self):
        ...
        Data1=pd.read_csv("/home/learner/Desktop/ImmoLiza_reg/Regression_Hussain/Data/Final_cleaned_Data.csv")
...
## Adding GDP for each province 
    ...
    def Avg (self):
        ...
        provinces = ["Antwerpen", "Brussel", "Oost-Vlaanderen", "Vlaams-Brabant", "Henegouwen", "Luik", "Limburg", "Luxemburg", "Namen", "Waals-Brabant", "West-Vlaanderen"] 
        average_prices = [2577, 3323, 2546, 2841, 1618, 1949, 2193, 1985, 2084, 2729, 2888] # Create the DataFrame 
